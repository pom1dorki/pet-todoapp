...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_pom1dorki_pet-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_pom1dorki_pet-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string"
        ...
        "internal_features_tasks_transport_http.CreateTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    ...
                    "maxLength": 1000,
                    "minLength": 1,
                    "example": "Сделать 5 задач по математике"
                },
                "title": {
                    "type": "string",
                    "maxLength": 100,
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Сделать домашку до четверга"
                },
                "id": {
                    "type": "integer",
                    "example": 15
